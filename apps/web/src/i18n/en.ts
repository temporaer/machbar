...
const en = {
  ...
  captureResolvedTokens: "Resolved details",
  captureSuggestions: "Short syntax suggestions",
  save: "Save",
  cancel: "Cancel",
  discard: "Discard",
  notes: "Notes",
  ...
  newTask: "New task",
  create: "Create",
  captureModifiers: "Additional details",
  ...
  titleHintFollowUp: (value: string) => `Follow up: ${value}`,
  addDeadline: "+ Add deadline",
  taskWaitQuestion: "What are you waiting for?",
  taskWaitRevisitQuestion: "When should you check again?",
  startWaitingConfirm: "Wait",
  ...
  deleteProjectChoiceTitle: "Delete project",
  deleteProjectChoicePrompt: "What should happen to this project's tasks?",
  deleteProjectOnlyLabel: "Delete project only",
  deleteProjectOnlyHint: "Tasks remain, no longer assigned to a project",
  deleteProjectWithTasksLabel: "Delete project and all tasks",
  deleteProjectWithTasksHint: "All of its tasks are permanently deleted too",
  ...
  railMore: "More",
  availabilitySameDayHint: "Not before:",
  availabilitySameDayGroup: "Same day",
  availabilityInAWhile: "In a while",
  availabilityTonight: "Tonight",
  availabilityFutureHint: "Or from another time:",
  availabilityFutureGroup: "Availability",
  availabilityCustomDate: "Custom date",
  availabilityCustomTime: "Time",
  clearNotBefore: "Clear availability date",
  availabilityMorePlanningOptions: "Plan / deadline …",
  structure: "Structure",
  structureSplit: "Break down",
  structureMove: "Move …",
  structureConvertToProject: "Make project",
  structurePlanWork: "Capture next task",
  ...
  cancelTask: "Cancel",
  projectDeadlineTitle: "Project deadline",
  taskSummary: "Tasks",
  ...
  mcp: "Copilot / MCP",
  mcpLinkHint: "Connect Copilot securely to Machbar",
  mcpCreateAgent: "Connect agent",
  mcpCreateHint:
    "Create a revocable access token for an MCP client. The token is shown only once.",
  mcpAgentName: "Name",
  mcpScope: "Fixed scope",
  mcpScopeWork: "Work",
  mcpScopeHousehold: "Household",
  mcpScopeWorkHint:
    "The agent can only see and change tasks and projects in the Work scope.",
  mcpScopeHouseholdHint:
    "The agent can only see and change tasks and projects in the Household scope.",
  mcpCreate: "Create token",
  mcpTokenOnce: "Copy this token now. It will not be shown again.",
  mcpEndpoint: "MCP endpoint",
  mcpToken: "Access token",
  mcpConfigureHint:
    "Open /mcp in Copilot CLI and add a remote HTTP server using this endpoint and token as an Authorization: Bearer header.",
  mcpAgents: "Connected agents",
  mcpNoAgents: "No MCP agents connected yet.",
  mcpRevoke: "Revoke",
  mcpRevoked: "revoked",
  ...
  pushDeviceHint: "Web Push in this browser or installed PWA",
  ...
  pushDenied: "Notifications are blocked in the browser or site settings.",
  pushPermissionPending:
    "The browser is waiting for your permission. Allow notifications from the address bar or site settings.",
  ...
  apiErrorMessages: {
    ...
    task_availability_date_required:
      "The local date for this availability time is missing.",
