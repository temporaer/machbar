...
const en = {
  ...
  splitTaskSteps: "Steps",
  splitTaskPlaceholder: "Check packages\nBuild cabinet\nInstall doors",
  splitTaskHint: "One child task per line.",
  ...
  railFavoritesTitle: "Swipe rail favorites",
  railFavoritesHint:
    "Choose the three visible commands for each row type. “More …” always remains the fourth slot and contains the remaining commands.",
  taskRailFavorites: "Tasks",
  projectRailFavorites: "Projects",
  railCommandLabels: {
    "task.plan": "Plan",
    "task.waitingLifecycle": "Wait / Follow up",
    "task.split": "Break down",
    "task.assignOwner": "Assign",
    "task.changeProject": "Change project",
    "task.addSuccessor": "Add successor",
