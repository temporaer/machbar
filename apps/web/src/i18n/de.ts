...
const extra = {
  ...
  titleHintFollowUp: (value: string) => `Wiedervorlage: ${value}`,
  ...
  deleteProjectOnlyLabel: "Nur das Projekt löschen",
  deleteProjectOnlyHint: "Aufgaben bleiben erhalten und werden keinem Projekt mehr zugeordnet",
  deleteProjectWithTasksLabel: "Projekt und alle Aufgaben löschen",
  deleteProjectWithTasksHint: "Alle zugehörigen Aufgaben werden ebenfalls endgültig gelöscht",
  ...
  mcp: "Copilot / MCP",
  mcpLinkHint: "Copilot sicher mit Machbar verbinden",
  mcpCreateAgent: "Agent verbinden",
  mcpCreateHint:
    "Erstelle ein widerrufbares Zugriffstoken für einen MCP-Client. Das Token wird nur einmal angezeigt.",
  mcpAgentName: "Name",
  mcpScope: "Fester Bereich",
  mcpScopeWork: "Arbeit",
  mcpScopeHousehold: "Haushalt",
  mcpScopeWorkHint:
    "Der Agent kann ausschließlich Aufgaben und Projekte im Bereich Arbeit sehen und ändern.",
  mcpScopeHouseholdHint:
    "Der Agent kann ausschließlich Aufgaben und Projekte im Bereich Haushalt sehen und ändern.",
  mcpCreate: "Token erstellen",
  mcpTokenOnce: "Kopiere dieses Token jetzt. Es wird nicht erneut angezeigt.",
  mcpEndpoint: "MCP-Endpunkt",
  mcpToken: "Zugriffstoken",
  mcpConfigureHint:
    "Öffne in Copilot CLI /mcp und füge einen Remote-HTTP-Server mit diesem Endpunkt und dem Token als Authorization: Bearer-Header hinzu.",
  mcpAgents: "Verbundene Agents",
  mcpNoAgents: "Noch keine MCP-Agents verbunden.",
  mcpRevoke: "Widerrufen",
  mcpRevoked: "widerrufen",
